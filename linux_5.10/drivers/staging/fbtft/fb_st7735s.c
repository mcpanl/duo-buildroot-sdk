...
static const s16 default_init_sequence[] = {
	...
	-1, 0x2B, 0x00, 0x18, 0x00, 0x67,

	-1, 0x2A, 0x00, 0x00, 0x00, 0x9F,
...
static void set_addr_win(struct fbtft_par *par, int xs, int ys, int xe, int ye)
{
	...
	write_reg(par, 0x2B, 0x00, 0x18, 0x00, 0x67);
	write_reg(par, 0x2A, 0x00, 0x00, 0x00, 0x9F);
	
	// printk("[ST7735S] set_addr_win");
